...
const Material = () => {
  ...
  const [selected, setSelected] = useState({
    title: "",
    utility: "",
    employee: fullname.split(" ")[0] + " " + fullname.split(" ")[2],
  });
  ...
  const addMaterialHandler = () => {
    ...
    formData.append("utility", selected.utility);
    formData.append("employee", selected.employee);
  ...
  return (
    <div className="w-full mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      ...
      <h2 className="mt-4 text-1.5xl font-bold text-red-600">
    Upload documents only in PDF format.
  </h2>
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center">
          ...
          <div className="w-[80%] mt-2">
            <label htmlFor="utility">Material Utility</label>
            <select
