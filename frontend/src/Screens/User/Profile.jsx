...
const Profile = () => {
  ...
  const changePasswordHandler = (id) => {
    ...
    axios
      .put(
        `${baseApiURL()}/user/auth/update/${id}`,
          ...
          <div>
            ...
            <div className="mt-3">
              <p className="text-lg font-normal mb-2">
                User Id: {data.enrollmentNo}
              </p>
              <p className="text-lg font-normal mb-2">Category: {data.category}</p>
              <p className="text-lg font-normal mb-2">
                Enrollment Year: {data.enrollmentYear}
              </p>
              <p className="text-lg font-normal mb-2">
            ...
            <button
              className={`${
                showPass ? "bg-red-600 text-white-600" : "bg-blue-600 text-white"
            ...
            {showPass && (
              ...
              >
                ...
                />
                 <button
  className="mt-4 px-6 py-3 bg-green-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 hover:border-blue-600 transition duration-300"
